    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-white to-neutral-50">
      <main className="flex-1 flex items-center justify-center">
        <div className="container mx-auto px-4 py-12 md:py-24">
          <div className="flex justify-center items-center mx-auto text-zinc-900 font-bold text-xl">
            <PiggyBank className="h-6 w-6 mr-2" />
            <span>Apoia</span>
          </div>
          <div className="max-w-md mx-auto text-center mt-4">
            <h1 className="text-3xl font-bold mb-4 text-zinc-900">Bem-vindo!</h1>
          ...
          <div className="max-w-96 mx-auto text-center">
            <div className="sm:flex sm:gap-4">
              <Button
                ...
                onClick={LoginGoogle}
                size="lg"
                className="bg-gradient-to-r from-zinc-900 to-gray-800 mt-5 cursor-pointer text-white font-medium"
              >
                Entrar com Google
